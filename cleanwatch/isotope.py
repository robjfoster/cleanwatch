...
class Isotope():
    ...
    def __init__(self, Z, half_life, NA, chain=None, name=None):
        self.Z = Z
...
isotopes = {
    "U238":  Isotope(238, 4.47e9, 0.9928, chain=chains['U238'], name="U238"),
    "U235":  Isotope(235, 7.04e8, 0.0072, chain=chains['U235'], name="U235"),
    "Th232": Isotope(232, 1.41e10, 0.9998, chain=chains['Th232'], name="Th232"),
    "Rn222": Isotope(222, 3.82/365.25, 1, chain=chains['Rn222'], name="Rn222"),
